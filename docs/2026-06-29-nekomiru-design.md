...
- **Pricing** (per client request — same tiers as reference, daily rate changed to ¥3,500):
  - 日々のお世話 (daily care: feeding, litter, health check, play, report) — tiers by visit duration: **30 min ¥3,500** / **60 min ¥4,500** (tax incl.; any number of cats, no extra charge) — **superseded 2026-07-30: the cat-only plan was levelled up to match わんにゃんプラン exactly — 30 min ¥4,000 / 1 hr ¥5,000 / 2 hr ¥8,000 / twice-daily 30 min ¥7,500 / twice-daily 1 hr ¥8,500. The twice-daily 30 min tier was then removed the same day, and the remaining twice-daily tier was relabelled 朝夕2回 (duration dropped) at ¥8,000 — and the 2 hr tier was dropped — leaving three tiers: 30 min ¥4,000 / 1 hr ¥5,000 / 朝夕2回 ¥8,000.**
  - わんにゃんプラン (Cat & Dog Plan) — by visit duration: **30 min ¥4,000** / **60 min ¥5,000** (tax incl.; cats plus a cohabiting dog; no pet limit; vaccines & flea/tick prevention required) — **superseded 2026-07-30: this plan card was REMOVED from the site** (its prices had just been merged into 日々のお世話, making the two cards identical). The お散歩 option was kept on the page by explicit client instruction, so its subtitle still reads 「わんにゃんプランに追加できます」; about2Body also still references the plan.
  ...
  - 初回カルテ作成 (one-time chart-creation fee, first booking only): **¥1,000** (tax incl.). Shown as subtle fine print. (Briefly raised to ¥1,500 on 2026-07-30, then reverted to ¥1,000 the same day.)
