...
- **Pricing** (per client request — same tiers as reference, daily rate changed to ¥3,500):
  - 日々のお世話 (daily care: feeding, litter, health check, play, report) — tiers by visit duration: **30 min ¥3,500** / **60 min ¥4,500** (tax incl.; any number of cats, no extra charge) — **superseded 2026-07-30: the cat-only plan was levelled up to match わんにゃんプラン exactly — 30 min ¥4,000 / 1 hr ¥5,000 / 2 hr ¥8,000 / twice-daily 30 min ¥7,500 / twice-daily 1 hr ¥8,500. The twice-daily 30 min tier was then removed the same day, and the remaining twice-daily tier was relabelled 朝夕2回 (duration dropped) at ¥8,000 — and the 2 hr and 30 min (クイックコース) tiers were dropped — leaving three tiers: 1日1回（45分ほど）¥4,000 / 1日1回（60分ほど）¥5,000 / 朝夕2回 ¥6,500.**
  ...
  - 初回カルテ作成 (one-time chart-creation fee, first booking only): **¥1,000** (tax incl.) — **superseded 2026-07-30: now ¥2,000.** Shown as subtle fine print.
