...
(function () {
  ...
  const I18N = {
    ...
    about2Title: { ja: "猫専門だから安心", en: "Cats are our specialty" },
    about2Body: { ja: "犬はお預かりしません。猫の気持ちと習性を第一に考えた、猫専門のお世話です。", en: "We care for cats only — no dogs — with their feelings and habits always coming first." },
    ...
    priceUnit: { ja: "／1回", en: "/ visit" },
    price1Note: { ja: "猫5匹まで／大阪市内の交通費込み", en: "Up to 5 cats · travel within Osaka City included" },
    ...
    faqA6: { ja: "日々のお世話は猫5匹まで同一料金で承ります。6匹以上の場合はご相談ください。", en: "Daily care covers up to 5 cats for the same price. For 6 or more, please ask." },
