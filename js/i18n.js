...
(function () {
  ...
  const I18N = {
    ...
    price1Freq4Label: { ja: "朝夕2回/45分", en: "Twice a day · 45 min each" },
    price1Note: { ja: "猫ちゃんは何匹でも追加料金なし・ワクチン＆ノミダニ予防が条件", en: "Any number of cats, no extra charge · vaccines & flea/tick prevention required" },
    ...
    price5Freq1Label: { ja: "30分クイックコース", en: "30-min Quick Course" },
    price5Freq2Label: { ja: "1時間", en: "1 hour" },
    price5Freq3Label: { ja: "2時間", en: "2 hours" },
    price5Freq4Label: { ja: "朝夕2回/45分", en: "Twice a day · 45 min each" },
    price5Note: { ja: "頭数制限なし・ワクチン＆ノミダニ予防が条件", en: "No pet limit · vaccines & flea/tick prevention required" },
    ...
    feeNote: { ja: "交通費：対象エリア内 税込500円/回／エリア外は別途ご相談", en: "Travel fee: ¥500 per visit within our service area (tax incl.) / outside the area by consultation" },
    kartNote: { ja: "初回のみ・カルテ作成料 税込1000円", en: "First booking only — ¥1000 chart-creation fee (tax incl.)" },
    priceCancel: {
      ja: "キャンセル料：ご利用日の15日前以内は50％、10日前以内は100％を申し受けます。",
      en: "Cancellation: 50% within 15 days of the booked date, 100% within 10 days.",
    },
