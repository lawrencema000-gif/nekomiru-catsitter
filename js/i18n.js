...
(function () {
  ...
  const I18N = {
    ...
    about2Body: { ja: "猫の気持ちと習性を第一に考えたお世話を。猫ちゃんと同居の（お散歩のいらない）わんちゃんも、わんにゃんプランで一緒にお世話します。", en: "Care built around cats' feelings and habits — and through our Cat & Dog Plan we'll also look after a cohabiting (non-walking) dog." },
    ...
    priceLead: { ja: "大阪市内の交通費込み。ご不明な点はお気軽にお問い合わせください。", en: "Travel within Osaka City included. Please ask us about anything unclear." },
    ...
    price1Freq1Label: { ja: "1日1回（45分程度）", en: "Once a day (about 45 min)" },
    price1Freq2Label: { ja: "1日2回（朝・夕）", en: "Twice a day (morning & evening)" },
    price1Note: { ja: "税込・猫は何匹でも追加料金なし・大阪市内の交通費込み", en: "Tax included · any number of cats, no extra charge · travel within Osaka City included" },
    ...
    price3Title: { ja: "その他カスタムサポート", en: "Other custom support" },
    price3Desc: { ja: "植物の水やりなど、ご希望に合わせて", en: "Plant watering and more, tailored to you" },
    priceFrom: { ja: "〜", en: "+" },
    price3Note: { ja: "内容に応じてご相談ください", en: "Please ask us about the details" },
    ...
    price5Desc: { ja: "猫ちゃんと同居の（お散歩なしの）わんちゃんも一緒にお世話", en: "Care for your cats plus a cohabiting (non-walking) dog" },
    price5Freq1Label: { ja: "1日1回（60分程度）", en: "Once a day (about 60 min)" },
    price5Freq2Label: { ja: "1日2回（朝・夕）", en: "Twice a day (morning & evening)" },
    ...
    flowF1B: { ja: "メール・フォーム・LINEからお気軽にご連絡ください。", en: "Reach out easily by email, form or LINE." },
    ...
    faqA2: { ja: "1日1回が基本ですが、1日2回などのご希望にも対応できます。猫ちゃんの頭数やご様子に合わせてご相談ください。", en: "Once a day is standard, but twice-daily and other schedules are possible. Let's tailor it to your cats." },
    ...
    faqA4: { ja: "空き状況によっては当日・前日のご依頼も承ります。まずはお電話かLINEでお問い合わせください。", en: "Depending on availability, same-day or next-day requests may be possible. Please ask by phone or LINE." },
    ...
    voice2: { ja: "人見知りのうちの子が、初回の顔合わせですっかり安心していました。女性スタッフさんだけというのも決め手でした。", en: "My shy cat was completely at ease after the first meeting. Women-only staff was the deciding factor for me." },
