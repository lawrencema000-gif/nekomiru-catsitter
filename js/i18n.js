...
(function () {
  ...
  const I18N = {
    ...
    price1Freq2Label: { ja: "1日2回（朝・夕・各60分程度）", en: "Twice a day (morning & evening, about 60 min each)" },
    ...
    price5Freq2Label: { ja: "1日2回（朝・夕・各60分程度）", en: "Twice a day (morning & evening, about 60 min each)" },
