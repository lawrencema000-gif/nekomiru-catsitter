...
(function () {
  ...
  const I18N = {
    ...
    price1Note: { ja: "税込・猫ちゃん2匹まで同料金・3匹目以降+800円・ワクチン＆ノミダニ予防が条件", en: "Tax incl. · same price for up to 2 cats · +¥800 from the 3rd cat · vaccines & flea/tick prevention required" },
    ...
    faqA6: { ja: "もちろんです。猫ちゃん2匹までは同一料金でご利用いただけます。3匹目以降は+800円です。", en: "Absolutely. Up to 2 cats are covered at the same price; from the 3rd cat onward there's a +¥800 charge." },
