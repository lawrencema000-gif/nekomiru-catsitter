...
(function () {
  ...
  const I18N = {
    ...
    price1Freq4Label: { ja: "朝夕2回（1時間ずつ）", en: "Twice a day (1 hour each)" },
    price1Freq5Label: { ja: "朝夕2回（30分ずつ）", en: "Twice a day (30 min each)" },
    ...
    price5Freq1Label: { ja: "クイックコース（30分）", en: "Quick Course (30 min)" },
    price5Freq2Label: { ja: "1時間", en: "1 hour" },
    price5Freq3Label: { ja: "2時間", en: "2 hours" },
    price5Freq4Label: { ja: "朝夕2回（1時間ずつ）", en: "Twice a day (1 hour each)" },
    price5Freq5Label: { ja: "朝夕2回（30分ずつ）", en: "Twice a day (30 min each)" },
    ...
    kartNote: { ja: "初回のみ・カルテ作成料 1500円（税込）", en: "First booking only — ¥1500 chart-creation fee (tax incl.)" },
    priceCancel: {
