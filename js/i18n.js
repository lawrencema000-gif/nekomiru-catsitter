...
(function () {
  ...
  const I18N = {
    ...
    price1Note: { ja: "税込・猫ちゃん2匹まで同料金・3匹目以降は1匹につき+800円・ワクチン＆ノミダニ予防が条件", en: "Tax incl. · same price for up to 2 cats · +¥800 per additional cat from the 3rd · vaccines & flea/tick prevention required" },
    ...
    optWalk2: { ja: "お散歩（プラン時間内）", en: "Walk (within plan time)" },
    ...
    faqA6: { ja: "もちろんです。猫ちゃん2匹までは同一料金でご利用いただけます。3匹目以降は1匹につき+800円です。", en: "Absolutely. Up to 2 cats are covered at the same price; from the 3rd cat onward it's +¥800 per cat." },
